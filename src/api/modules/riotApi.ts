...
export default {
  ...
  getProfileImg: (profileId: number) => axios.get(`http://ddragon.leagueoflegends.com/cdn/10.16.1/img/profileicon/${profileId}.png`),

  // 스펠 이미지 -> img tag에 바로 호출할것
  getSpellImg: (spellName: string) => axios.get(`http://ddragon.leagueoflegends.com/cdn/10.16.1/img/spell/${spellName}.png`),
};
